...
<div class="min-h-screen bg-gray-50 py-8">
    <div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        <div class="bg-white shadow rounded-2xl p-6">
            <div class="mb-6">
                <h1 class="text-2xl font-bold text-gray-900">Solicitação de Reembolso</h1>
                <p class="mt-2 text-sm text-gray-600">Preencha os dados abaixo para solicitar reembolso ao financeiro.</p>
            </div>

            <form action="{{ route('tickets.store-reimbursement') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                @csrf
                ...
                <div>
                    ...
                    <input
                        ...
                        placeholder="Ex: Reembolso de viagem a São Paulo"
                    >
                    @error('title')
                ...
                <!-- Aprovador -->
                <div>
                    <label for="approver_id" class="block text-sm font-medium text-gray-700">Aprovador</label>
                    <select
                        id="approver_id"
                        name="approver_id"
                        class="mt-1 w-full rounded-lg border-gray-200 px-4 py-2 text-gray-700 shadow-sm focus:border-primary-500 focus:outline-none focus:ring-2 focus:ring-primary-500"
