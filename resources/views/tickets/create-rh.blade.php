...
<div class="min-h-screen bg-gray-50 py-8">
    <div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        <div class="bg-white shadow rounded-2xl p-6">
            <div class="mb-6">
                <h1 class="text-2xl font-bold text-gray-900">RH</h1>
                <p class="mt-2 text-sm text-gray-600">Solicitações do RH para o Financeiro</p>
            </div>

            <form action="{{ route('tickets.store-rh') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                @csrf
                ...
                <div class="grid gap-6 sm:grid-cols-2">
                    ...
                    <!-- Código Funcionário -->
                    <div>
                        <label for="employee_code" class="block text-sm font-medium text-gray-700">Código Funcionário</label>
                        <input
                            type="text"
                            id="employee_code"
                            name="employee_code"
