...
<div class="min-h-screen bg-gray-50 py-8">
    <div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        <div class="bg-white shadow rounded-2xl p-6">
            <div class="mb-6">
                <h1 class="text-2xl font-bold text-gray-900">Solicitação de Pagamento de Importações</h1>
                <p class="mt-2 text-sm text-gray-600">Preencha os dados abaixo para solicitar pagamento de importação ao financeiro.</p>
            </div>

            <form action="{{ route('tickets.store-import-payment') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                @csrf
                ...
                <div>
                    ...
                    <input
                        ...
                        placeholder="Ex: Pagamento de importação - Insumos"
                    >
                    @error('title')
                ...
                <div>
                    ...
                    <textarea
                        ...
                        rows="4"
                        class="mt-1 w-full rounded-lg border-gray-200 px-4 py-2 text-gray-700 shadow-sm focus:border-primary-500 focus:outline-none focus:ring-2 focus:ring-primary-500"
                        placeholder="Descreva a justificativa para o pagamento de importação..."
